...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Computer Generated Imagery</li>
        </ol>
    </section>
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            if ($list['AvgcIncubation']['type'] == 'Computer Generated Imagery') {
...
<script>
    $('.imagery').addClass('active').parents('li').addClass('active')
</script>