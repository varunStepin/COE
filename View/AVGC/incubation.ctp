...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Incubation</li>
        </ol>
    </section>
            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('AvgcIncubation', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "AVGC", "action" => "incubation")));
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            if ($list['AvgcIncubation']['type'] == 'Incubation') {
                                                $id = $list['AvgcIncubation']['id'];
                                    ?>
                                                <tr>
                                                    <td><?php echo $i++; ?></td>
                                                    <td><?php echo $list['AvgcIncubation']['phase']; ?></td>
                                                    <td><?php echo $list['AvgcIncubation']['startup_name']; ?></td>
                                                    <td><?php echo date('d-m-Y',strtotime($list['AvgcIncubation']['incubation_start_date'])); ?></td>
...
<?php echo $this->Form->create('AvgcIncubation', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "AVGC", "action" => "incubation")));
...
<script>
    $('.incubation').addClass('active').parents('li').addClass('active')
</script>