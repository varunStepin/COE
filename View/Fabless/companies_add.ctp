            ...
            <div class="col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php echo $this->Html->link('Company List', array("controller" => "Fabless", "action" => "companies"), array("class" => "btn btn-info btn-sm pull-right", "escape" => false,));
                    ...
                    <div class="box-body">
                        ...
                        <?php echo $this->Form->create('Companies', array("class" => "form-horizontal", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Fabless", "action" => "companies")));
						...
						<div class="form-group row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <?php $status=['Exist'=>'Exist','Closed'=>'Closed'];
                                        echo $this->Form->input("status", array("type" => "select", "label" => false, "options" => $status, "class" => "form-control", 'empty' => 'Select', 'required', 'default' => Date('Y'))); ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if (empty($this->request->data['Companies']['id'])) {
