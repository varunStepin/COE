  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Companies Incubates</li>
      </ol>
    </section>
			...
			<div class="col-12">         
				<div class="box">
					<div class="box-header with-border">
						<?php echo $this->Html->link('Add' ,array("controller"=>"Fabless","action"=>"companiesIncubatesAdd"), array("class"=>"btn btn-info btn-sm pull-right","escape"=>false)); ?>
					</div>
            <!-- /.box-header -->
            <div class="box-body">
				<div class="row">
...
<script>
    ...
    $('.companiesIncubates').addClass('active').parents('li').addClass('active');
</script>
