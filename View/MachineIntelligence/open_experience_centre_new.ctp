...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Open Experience Centre New
        </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="breadcrumb-item"><a href="#">Ktech</a></li>
            <li class="breadcrumb-item active">Open Experience Centre New</li>
        </ol>
    </section>
            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('OpenExperienceCentre', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "MachineIntelligence", "action" => "openExperienceCentreNew")));
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php echo $this->Form->input("startup_name", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Startup Name")) ?>
                                        <?php echo $this->Form->input("id", array("type" => "hidden", "label" => false, 'class' => "form-control", "value" => $this->request->data['OpenExperienceCentreNew']['id'])); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-form-label">Start Date<span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <?php echo $this->Form->input("start_date", array("type" => "text", "autocomplete" => "off", "id" => "datepicker", "label" => false, 'class' => "form-control ", 'required', 'placeholder' => 'DD-MM-YYYY')); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                                ...
                                                $id = $list['OpenExperienceCentre']['id']; ?>
                                                <tr>
                                                    <td><?php echo $i++; ?></td>

                                                    <td><?php echo $list['OpenExperienceCentre']['startup_name']; ?></td>
                                                    <td><?php echo $list['OpenExperienceCentre']['phase']; ?></td>
                                                    <td><?php echo date('d-m-Y',strtotime($list['OpenExperienceCentre']['start_date'])); ?></td>
                                                    <td><?php echo $list['OpenExperienceCentre']['founder_name']; ?></td>
                                                    <td><?php echo $list['OpenExperienceCentre']['email_address']; ?></td>
                                                    <td><?php echo $list['OpenExperienceCentre']['mobile_number']; ?></td>
                                                    <td><?php echo $list['OpenExperienceCentre']['address']; ?></td>
...
<?php echo $this->Form->create('OpenExperienceCentre', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "MachineIntelligence", "action" => "openExperienceCentreNew")));
...
<script>
   $('.open_experience_centre_new').addClass('active').parents('li').addClass('active')
</script>