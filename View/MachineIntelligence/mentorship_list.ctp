					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group">
									<label for="example-text-input" class="col-form-label">Start Up Name<span class="text-danger">*</span></label>
									<?php echo $this->Form->input("startup_name", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Startup Name")) ?>
								</div>

								<div class="form-group">
									<label for="example-text-input" class="col-form-label">Founder Name<span class="text-danger">*</span></label>
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><?php echo $manage['MiMentorship']['startup_name']; ?></td>
												<td><?php echo $manage['MiMentorship']['founder_name']; ?></td>
												<td><?php echo $manage['MiMentorship']['address']; ?></td>
												<td>
