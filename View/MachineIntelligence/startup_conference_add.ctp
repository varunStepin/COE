            ...
            <div class="col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php echo $this->Html->link('Conference List', array("controller" => "MachineIntelligence", "action" => "startupConference"), array("class" => "btn btn-info btn-sm pull-right", "escape" => false,));
                    ...
                    <div class="box-body">
                        ...
                        <?php echo $this->Form->create('MiStartupConferences', array("class" => "form-horizontal", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "MachineIntelligence", "action" => "startupConferenceAdd")));
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if (empty($this->request->data['MiStartupConferences']['id'])) {
