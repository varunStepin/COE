...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Startup Incubated</li>
		</ol>
	</section>
			...
			<div class="col-lg-4 col-12">
				...
				<div class="box">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-12">
								<?php echo $this->Form->create('TbiStartup', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => $details['Controller'], "action" => "startupIncubated")));
								echo $this->Form->input('csrf_token', array("type" => "hidden", 'id' => 'csrftoken', "label" => false, 'required', "class" => "form-control rounded", 'value' => ' '));
								echo $this->Form->input('type', array("type" => "hidden", "label" => false, 'required', "value" => "insert"));
								?>

								<div class="form-group ">
									<label for="example-text-input" class="col-form-label">UnSelected Startups(For incubation) <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group ">
                                    <label for="example-text-input" class="col-form-label">Incubation Start date <span class="text-danger">*</span></label>
                                    <?php echo $this->Form->input("incubation_start_date", array("type" => "text", "id" => "datepicker", "class" => "form-control st_date", "required", "label" => false, "placeholder" => "Incubation start date")) ?>
								...
								<tbody>
									...
									?>
											<tr>
                                                ...
                                                <td><?php echo date('d-m-Y', strtotime($manage['TbiStartup']['incubation_start_date'])); ?></td>
												<td>
...
<?php echo $this->Form->create('TbiStartup', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => $details['Controller'], "action" => "startupIncubated")));
