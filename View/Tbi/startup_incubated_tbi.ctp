...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Start-ups Incubated off TBI</li>
		</ol>
	</section>
	<!-- Main content -->
		...
		<div class="row">
			<div class="offset-md-2 col-md-8">
				<div class="box box-info" style="background-color:#fff">
					<div class="box-header with-border"><b>Start-ups Incubated off TBI</b>
					</div>
					<?php echo $this->Form->create('TbiStartup', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => $details['Controller'], "action" => "startupIncubatedTbi")));
						...
						<div class="row">
							<div class="col-12">
								...
								<div class="form-group">
									<div class="row">
										<div class="col-md-6">
											<label for="example-text-input" class="control-label">Non Incubated Startups off TBI<span class="text-danger">*</span></label>
										</div>
										<div class="col-md-6">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6">
											<?php echo $this->Form->input("tbi_status", array("type" => "text", "class" => "form-control st_status", "required", "label" => false, "placeholder" => "Status of Project")) ?>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6">
											<?php echo $this->Form->input("tbi_date", array("type" => "text", "id" => "datepicker", "class" => "form-control st_date", "required", "label" => false, "placeholder" => "Incubation start date")) ?>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-6">
											<?php echo $this->Form->input("tbi_outcome", array("type" => "text", "class" => "form-control st_outcome", "required", "label" => false, "placeholder" => "Outcome of Startup")) ?>
										</div>
									</div>
								</div>
							</div>
									...
									<tbody>
										...
										?>
												<tr>
													...
													<td><?php echo $manage['TbiStartup']['tbi_status']; ?></td>
													<td><?php echo $manage['TbiStartup']['tbi_date']; ?></td>
													<td><?php echo $manage['TbiStartup']['tbi_outcome']; ?></td>
													<td>
...
<?php echo $this->Form->create('TbiStartup', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => $details['Controller'], "action" => "startupIncubatedTbi")));
...
<script>
	var conrtoller = '.<?= $details['Controller'] ?>startupIncubatedTbi'
