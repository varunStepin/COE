			...
			<div class="col-lg-4 col-12">
				...
				<div class="box">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-12">
								<?php echo $this->Form->create('TbiStartup', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => $details['Controller'], "action" => "startup")));
								...
								<div class="form-group ">
									...
									<?php echo $this->Form->input("details", array("type" => "textarea", "rows" => 4, "class" => "form-control", "required", "label" => false, "placeholder" => "Details of the founding team members for each startup and their designations")) ?>

								</div>
								<div class="form-group ">
									<label for="example-text-input" class="col-form-label">Type of Startup <span class="text-danger">*</span></label>
									<?php echo $this->Form->input("startup_type", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Type of Startup")) ?>
							...
							<table class="table example_long table-striped table-bordered table-hover">
								...
								<tbody>
									...
									?>
											<tr>
												<td><?php echo $i++; ?></td>
												<td><?php echo $manage['TbiStartup']['phase'] ?></td>
...
<?php echo $this->Form->create('TbiStartup', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => $details['Controller'], "action" => "startup")));
...
<script>
	var conrtoller = '.<?= $details['Controller'] ?>Startup'
