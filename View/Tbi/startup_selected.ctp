...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Startup Selected</li>
		</ol>
	</section>
			...
			<div class="col-lg-4 col-12">
				...
				<div class="box">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-12">
								<?php echo $this->Form->create('TbiStartup', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => $details['Controller'], "action" => "startupSelected")));
								echo $this->Form->input('csrf_token', array("type" => "hidden", 'id' => 'csrftoken', "label" => false, 'required', "class" => "form-control rounded", 'value' => ' '));
								echo $this->Form->input('type', array("type" => "hidden", "label" => false, 'required', "value" => "insert"));
								?>
							
								<div class="form-group ">
									<label for="example-text-input" class="col-form-label">UnSelected Startups <span class="text-danger">*</span></label>
									<?php echo $this->Form->input("id", array("type" => "select", "options" => $unselectedStartUps, "class" => "form-control startUpId", "required", "label" => false, "empty" => "Startup Name")) ?>
								...
								<div class="box-footer">
									<div class="clearfix pull-right">
										<?php
										echo $this->Form->button("Select", array("type" => "submit", "class" => "_save btn btn-danger btn-sm", "label" => false));
										?>
									</div>
								</div>
...
<?php echo $this->Form->create('TbiStartup', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => $details['Controller'], "action" => "startupSelected")));
...
<script>
	...
	$('.startUpId').on('change', function() {
		...
		console.log(details)
		$('.st_details').val(details[id]['details'])
		$('.st_type').val(details[id]['startup_type'])
	});
</script>
<script>
	var conrtoller = '.<?= $details['Controller'] ?>StartupSelected'
