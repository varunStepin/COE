...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-dashboard"></i><?php echo $this->Html->link('<span>TBI  </span>',array("controller"=>"Admin","action"=>"dashboard"),array("escape"=>false));?></li>
			  ...
			  <div class="box">
				...
				<div class="box-body">
					<div class="row">
				  	...
				  	<div class="row">
						<div class="col-12">
							<?php echo $this->Form->create('TbiTarget',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Tbi","action"=>"target")));
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									// print_r($manage_list);
									$id = $list['TbiTarget']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['TbiTarget']['phase'];?></td>
							<td><?php echo ($targetType[$list['TbiTarget']['type']]!='')?$targetType[$list['TbiTarget']['type']]:$list['TbiTarget']['type'];?></td>
							<td><?php echo $list['TbiTarget']['count'];?></td>
							<td><?php echo $list['TbiTarget']['year'];?></td>
							<td>
...
<?php echo $this->Form->create('TbiTarget',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Tbi","action"=>"target")));
