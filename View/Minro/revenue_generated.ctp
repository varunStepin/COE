              ...
              <div class="col-lg-4 col-12">
                  <div class="box">
                      <div class="box-body">
                          ...
                          <div class="row">
                              <div class="col-12">
                                  <?php echo $this->Form->create('RevenueGenerated',array("class"=>"form-horizontal","type"=>"file",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Minro","action"=>"revenueGenerated")));
                                  echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                                  echo $this->Form->input('type',array("type"=>"hidden","label"=>false,'required',"value"=>"insert"));
								  echo $this->Form->input('belongs_to',array("type"=>"hidden","label"=>false,'required',"value"=>"MINRO"));?>
							    ...
							    <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <label for="example-text-input" class=" col-form-label">Year<span class="text-danger">*</span></label>
                                          ...
                                          <?php echo $this->Form->input("year",array("type"=>"text","class"=>"form-control isDecimalNumber", "maxlength"=>4, "required","label"=>false,"placeholder"=>"Year"))?>
...
<?php echo $this->Form->create('RevenueGenerated',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Minro","action"=>" revenueGenerated")));
...
<script>
    ...
    $('.MinroRevenueGenerated').addClass('active').parents('li').addClass('active')
</script>
