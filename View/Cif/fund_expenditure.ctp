            ...
            <div class="col-lg-10 col-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <?php echo $this->Form->create('CifExpenditure', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Cif", "action" => $action)));
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-5 col-form-label">Supporting Documents</label>
                                    <div class="col-sm-7">
...
<?php echo $this->Form->create('CifExpenditure', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Cif", "action" => "fundExpenditure")));
