...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Cif Fund Details</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <?php echo $this->Form->input("id", array("type" => "hidden", "label" => false, 'class' => "form-control", "value" => $this->request->data['CifFund']['id'])); ?>
                                </div>
                                <div class="form-group ">
                                    <label for="example-text-input" class=" col-form-label">Organization<span class="text-danger">*</span></label>

                                    <?php echo $this->Form->input("types", array("type" => "select", "empty" => "Select Organization", "options" => $organization, "required", "class" => "form-control", "label" => false, "placeholder" => "Select Organization")) ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <?php echo $this->Form->input("financial_year_id", array("type" => "select", "empty" => "Select Funding Year", "required", "options" => $financialYear, "class" => "form-control", "label" => false, "placeholder" => "Funding Year")) ?>
                                ...
                                <div class="form-group ">
                                    <?php
                                    $doc_req = 'required';
                                    if ($this->request->data['CifFund']['upload_uc'] != '') $doc_req = '';
                                    ?>
                                    ...
                                    echo $this->Form->input('upload_uc_old', array("type" => "hidden", "label" => false, "value" => $this->request->data['CifFund']['upload_uc'])); ?>
                                    <span class="text-danger"><?= $this->request->data['CifFund']['upload_uc'] ?></span>
                                </div>

                                <div class="form-group ">
                                    <?php
                                    $doc_req = 'required';
                                    if ($this->request->data['CifFund']['upload_bs'] != '') $doc_req = '';
                                    ?>
                                    ...
                                    echo $this->Form->input('upload_bs_old', array("type" => "hidden", "label" => false, "value" => $this->request->data['CifFund']['upload_bs'])); ?>
                                    <span class="text-danger"><?= $this->request->data['CifFund']['upload_bs'] ?></span>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="box-footer">
                                    <div class="clearfix pull-right">
                                        ...
                                        <?php
                                        if (empty($this->request->data['CifFund']['id'])) {
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $manage['CifFund']['amount_utilized']; ?></td>
                                                <td><?= $manage['CifFund']['approved_amount'] - $manage['CifFund']['amount_utilized'] ?></td>
                                                <td><?php echo $manage['FinancialYear']['year']; ?></td>
                                                <td><?php if ($manage['CifFund']['upload_uc'] != "") { ?>
                                                        <a href="<?php echo $this->webroot; ?>upload_uc/<?php echo $manage['CifFund']['upload_uc']; ?>" target="_blank">View</a>
                                                    <?php } ?>
                                                </td>
                                                <td><?php if ($manage['CifFund']['upload_bs'] != "") { ?>
                                                        <a href="<?php echo $this->webroot; ?>upload_bs/<?php echo $manage['CifFund']['upload_bs']; ?>" target="_blank">View</a>
                                                    <?php } ?>
                                                </td>
                                                <td><?php echo $manage['CifFund']['opening_balance']; ?></td>
                                                <td><?php echo $manage['CifFund']['expenses_type']; ?></td>
                                                <td><?php echo $manage['CifFund']['remarks']; ?></td>
                                                <td>
...
<?php echo $this->Form->create('CifFund', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Cif", "action" => 'fund')));
