		...
		<div class="col-lg-12 col-12">
			<div class="box">
                <div class="box-header with-border">
                    <?php echo $this->Html->link('<span>Participants Add  </span>',array("controller"=>"Cif","action"=>"externalEventParticipant"),array("escape"=>false,"class"=>'btn btn-info btn-sm pull-right'));?>
                </div>
            <!-- /.box-header -->
            <div class="box-body">
						...
						<?php 
							...
							if (!empty($participants_list)) {
								...
								foreach ($participants_list as $list) {
									$id = $list['CifExternalEventParticipant']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
...
<?php echo $this->Form->create('CifExternalEventParticipant',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Cif","action"=>"externalEventParticipantsList")));
...
<script>
    $('.externalEventParticipantList').addClass('active').parents('li').addClass('active');
</script>
