		...
		<div class="col-lg-12 col-12">
			<div class="box">
                <div class="box-header with-border">
                    <?php echo $this->Html->link('<span>Participants Add  </span>',array("controller"=>"Cif","action"=>"roundtableParticipants"),array("escape"=>false,"class"=>'btn btn-info btn-sm pull-right'));?>
                </div>
            <!-- /.box-header -->
            <div class="box-body">
						...
						<?php 
							...
							if (!empty($participants_list)) {
								...
								foreach ($participants_list as $list) {
									$id = $list['CifRoundtableParticipant']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
...
<?php echo $this->Form->create('CifRoundtableParticipant',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Cif","action"=>"roundtableParticipantsList")));
