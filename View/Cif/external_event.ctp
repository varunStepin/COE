			...
			<div class="col-lg-5 col-12">
				<div class="box">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-12">
								<?php echo $this->Form->create('CifExternalEvent', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Cif", "action" => "externalEvent")));
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<?php echo $this->Form->input("no_woman_participants", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "No of Woman Participants")) ?>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<?php echo $this->Form->input("percentage_woman_participants", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Percentage of Woman Participants")) ?>
									</div>
								</div>
								...
								<div class="box-footer">
									<div class="clearfix pull-right">
										...
										<?php
										if (empty($this->request->data['CifExternalEvent']['id'])) {
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td class="text-nowrap"><?php echo date('d-m-Y', strtotime($list['CifExternalEvent']['date'])); ?></td>
												<td><?php echo $list['CifExternalEvent']['no_participants']; ?></td>
												<td><?php echo $list['CifExternalEvent']['no_woman_participants']; ?></td>
												<td><?php echo $list['CifExternalEvent']['percentage_woman_participants']; ?></td>
...
<?php echo $this->Form->create('CifExternalEvent', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Cif", "action" => "externalEvent")));
...
<script>
	$('.externalEvent').addClass('active').parents('li').addClass('active')
</script>