...
<div class="content-wrapper">
    ...
    <section class="content mainCards">
		<?php $userType = $this->Session->read('USER_TYPE'); ?>
		 ...
		 <div class="row">
			 <div class="col-md-12" align="center">
					<button type="button" class="btn btn-info">COE Deliverables Dashboard</button>
			 </div>
		 </div>
		 <br/>
		 <?php } ?>
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('dataScienceDashboard')">
                <div class="box box-body bg-1 bg-2 pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <!--<h6 class="text-uppercase height-36">K-tech COE for DS&AI</h6>-->
                    <img class="card-image-center" src="<?php echo $this->webroot ?>img/logos/dsai.png" >
                     <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $DataScience['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $DataScience['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'AEROSPACE & DEFENSE'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('aerospaceDashboard')">
                <div class="box box-body bg-2 pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <center><h5 class="text-uppercase pt-15">K-tech COE in A&amp;D</h5></center>
                     <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $Aerospace['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $Aerospace['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->

                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'CYBER SECURITY'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('cyberSecurityDashboard')">
                <div class="box box-body bg-3 pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <!--</center><h6 class="text-uppercase height-36">K-tech COE in CS</h6>-->
                    <img class="card-image-center" src="<?php echo $this->webroot ?>img/logos/cybersecurity.png" >
                    <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $Cyber['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $Cyber['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'ANIMATION'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('animationDashboard')">
                <div class="box box-body bg-4 pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
					<center><h5 class="text-uppercase  pt-15">K-tech COE in AVGC</h5></center>
                    <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $Animation['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $Animation['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'KTECH CENTRE'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('ktechCenterDashboard')">
                <div class="box box-body bg-5 pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <!--<h6 class="text-uppercase height-36">K-tech COE by C-Camp</h6>-->
                    <img class="card-image-center" src="<?php echo $this->webroot ?>img/logos/ktech.png" >
                    <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $Camp['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $Camp['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'IOT'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('iotDashboard')">
                <div class="box box-body bg-6 text-white pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <!--<h6 class="text-uppercase height-36">K-tech COE on IoT</h6>-->
                    <img class="card-image-center" src="<?php echo $this->webroot ?>img/logos/iot.png" >
                    <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $IoT['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $IoT['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'MI & ROBOTICS'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('miRoboticsDashboard')">
                <div class="box box-body bg-7 text-white pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <center><h5 class="text-uppercase  pt-15">K-tech COE - MINRO</h5></center>
                    <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $Machine['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $Machine['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
            <?php } if($userType=='Admin' || $userType == 'FABLESS'){ ?>
            <div class="col-xl-3 col-md-6 col-12 px-5" onclick="openDashboard('fablessDashboard')">
                <div class="box box-body bg-8 text-white pt-25 pb-25" style="cursor: pointer;display:block;width:100%;height:100px;  ">
                    <!-- <h6 class="text-uppercase height-36">K-tech COE - SFAL</h6>-->
                    <img class="card-image-center" src="<?php echo $this->webroot ?>img/logos/sfal.png" >
                    <!--<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Allocated</strong></i>
                        <span class=" font-size-30"><?php echo $Fabless['Financials']['approved_amount']; ?> <span class='amount_in'>Cr</span></span>
                    </div>
					<div class="flexbox mt-2">
                        <i class="font-size-25"><strong>Fund Utilized</strong></i>
                        <span class=" font-size-30"><?php echo $Fabless['Financials']['amount_utilized']; ?> <span class='amount_in'>Cr</span></span>
                    </div>-->
                </div>
            </div>
             <?php } ?>
            ...
            <div class="col-12">
                    <div class="box fundCard">
                        <div class=" box-header with-border">
							...
							<?php echo $this->Html->link('<span>Year wise data</span>', array("controller" => "Admin", "action" => "financialReport"), array("escape" => false,'class'=>'btn btn-warning btn-sm pull-right mr-5')); ?>
                        ...
                        <div class="box-body finance_section" >
							<div align="center">
								<button type="button" class="btn btn-info">COE <?= $this->Session->read('Phase'); ?> Financials Dashboard : <?= $current_financial_year; ?></button>
							</div>
...
<script>
    ...
    function openDashboard(type){
        if(type=='dataScienceDashboard')
            ...
            url ="<?= $this->html->url(array('controller'=>'Dashboard','action'=>'aerospaceDashboard?phase=Phase 1')) ?>";
            ...
            url="<?= $this->html->url(array('controller'=>'Dashboard','action'=>'animationDashboard?phase=Phase 1')) ?>";
...
<script>
    ...
    var modules=['Data Science and AI 2','Aerospace & Defense','Cyber Security','Animation','KTECH Centre','IOT','MI & Robotics', 'Fabless']
