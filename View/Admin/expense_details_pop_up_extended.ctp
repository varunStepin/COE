<div class="modal-header bg-info  font-size-30">
    <h5  class="box-title ">
       <?php echo $header.' Expense Details of '.date('M-Y',strtotime($expenseDetails[0]['Expenditure']['date'])) ?>
    </h5>
    ...
    <div class="table-wrapper-scroll-y">
        ...
        <div class="table-responsive model_slim_scroll" style="height: 500px">
            ...
            <table   class="table table-striped example_long table-bordered table-hover" >
                ...
                <tr>
                    <td><?php echo $i++ ?></td>
                    <td><?= $expense['Expenditure']['amount_spent'] ?></td>
                    <td><?= $expense['Expenditure']['expense_type'] ?></td>
                    <td><?= date('d-M-Y',strtotime($expense['Expenditure']['date'])) ?></td>
                    <td><?= date('d-M-Y',strtotime($expense['Expenditure']['end_date'])) ?></td>
                    <td><?= $expense['Expenditure']['details'] ?></td>
					<td>
						<?php if($expense['Expenditure']['document']!=""){?>
							<a href="<?php echo $this->webroot; ?>Expenditure_Documents/<?php echo $expense['Expenditure']['document'];?>" target="_blank">View</a>
						<?php } ?>
					</td>
