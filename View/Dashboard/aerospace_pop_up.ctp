...
<div class="modal-body ">
    <div class="table-wrapper-scroll-y">
        ...
        <div class="table-responsive model_slim_scroll" style="height: 500px">
            <!--/********************** First Graph **********************/-->
            <?php if($type=='Internship' || $type=='AdvanceCourse' || $type=='OrientationCourse'){?>
            <table class="table table-striped example_long table-bordered table-hover" >
                ...
                <?php foreach($list_data as $key=>$list){
                    ...
                    <tr>
                        <td><?= ++$key ?></td>
                        <td><?= $list[$model_1]['internship_program_name'] ?></td>
            ...
            <table class="table table-striped example_long table-bordered table-hover" >
                ...
                <tr>
                    <th>Sl no.</th>
                    <th>Company Name</th><th>Phase</th>
                    <th>Details</th>
                </tr>
                </thead>
                <tbody>
                <?php foreach($list_data as $key=>$list){?>
                    <tr>
                        ...
                        <td><?= $list['ManageStartupFacilitation']['phase'] ?></td> <td><?= $list['ManageStartupFacilitation']['details'] ?></td>
                    </tr>
                <?php }?>
                </tbody>
            </table>
