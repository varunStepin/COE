    ...
    <section class="content drillDown">  
		<div class="row">
			<div class="col-md-12" align="center">
				<button type="button" class="btn btn-info">K-tech COE - MINRO</button>
			</div>
        </div>
        <div class="row mt-15">
            <div class="col-12 mb-20">
                <?php echo $this->Html->link('<span> Finance Dashboard <i class="fa fa-arrow-right"></i></span>',array("controller"=>"Dashboard","action"=>"financeDashboard","roboticsFund"),array('class'=>'btn btn-primary ml-10 pull-right btn-sm',"escape"=>false));?>
            ...
            <div class="col-12">
                <?php echo $this->element('Admin/Dashboard/mi_robotics'); ?>
            </div>
        </div>
    </section>
    <!--model pop Up-->
...
<script>
    $(function(){
       ...
       $.fn.loadModalData=function(type,year,month){
           $('#chartDetailModalContent').load('miRoboticsDashboard/'+type+'/'+year+'/'+month,function(){
