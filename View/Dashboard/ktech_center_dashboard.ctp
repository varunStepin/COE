    ...
    $(function () {
        ...
        Highcharts.chart('research_project', {
            ...
            series: [{
                name: 'Target',
                data: [
                    ['StartUp Incubated',final_array['CcampStartUpIncubated']['Target']['count'],'CcampStartUpIncubated-YearWise-Target',colors1[0]],
					['StartUp Graduated',final_array['CcampStartUpGraduated']['Target']['count'],'CcampStartUpGraduated-YearWise-Target',colors1[0]],
                    ...
                    ['Fund Raised By Startup',final_array['Startup']['Target']['count'],'Startup-YearWise-Target',colors1[0]],
                ...
                name: 'Achieved',
                data: [
                    ['StartUp Incubated',final_array['CcampStartUpIncubated']['Achieve']['count'],'CcampStartUpIncubated-YearWise-Achieved',colors1[1]],
					['StartUp Graduated',final_array['CcampStartUpGraduated']['Achieve']['count'],'CcampStartUpGraduated-YearWise-Achieved',colors1[1]],
                    ...
                    ['Fund Raised By Startup',final_array['Startup']['Achieve']['count'],'Startup-YearWise-Achieved',colors1[1]],
        ...
        Highcharts.chart('research_project1', {
            ...
            series: [{
                ...
                data: [
                    ...
                    ['CcampHackthon',final_array['CcampHackthon']['Target']['count'],'CcampHackthon-YearWise-Target',colors1[0]],
                    ['Pre Ideation',final_array['PreIdeation']['Target']['count'],'PreIdeation-YearWise-Target',colors1[0]],
                    ['Ideation',final_array['IdeationWorkshop']['Target']['count'],'IdeationWorkshop-YearWise-Target',colors1[0]],
                    ['Ecosystem Building Service',final_array['EcosystemBuildingService']['Target']['count'],'EcosystemBuildingService-YearWise-Target',colors1[0]],
                    ['CcampWorkshop',final_array['CcampWorkshop']['Target']['count'],'CcampWorkshop-YearWise-Target',colors1[0]],
                    ['NoOfNewProduct',final_array['NoOfNewProduct']['Target']['count'],'NoOfNewProduct-YearWise-Target',colors1[0]],
                ],
                keys: ['name', 'y', 'drilldown','color'],
                color:colors1[0]
            }, {
                ...
                data: [
                    ...
                    ['CcampHackthon',final_array['CcampHackthon']['Achieve']['count'],'CcampHackthon-YearWise-Achieved',colors1[1]],
                    ['Pre Ideation',final_array['PreIdeation']['Achieve']['count'],'PreIdeation-YearWise-Achieved',colors1[1]],
                    ['Ideation',final_array['IdeationWorkshop']['Achieve']['count'],'IdeationWorkshop-YearWise-Achieved',colors1[1]],
                    ['Ecosystem Building Service',final_array['EcosystemBuildingService']['Achieve']['count'],'EcosystemBuildingService-YearWise-Achieved',colors1[1]],
                    ['CcampWorkshop',final_array['CcampWorkshop']['Achieve']['count'],'CcampWorkshop-YearWise-Achieved',colors1[1]],
                    ['NoOfNewProduct',final_array['NoOfNewProduct']['Achieve']['count'],'NoOfNewProduct-YearWise-Achieved',colors1[1]],
                ],
                keys: ['name', 'y', 'drilldown','color'],
                color:colors1[1]
            }],
