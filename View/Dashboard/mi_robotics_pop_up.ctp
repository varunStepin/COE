...
<div class="modal-body ">
    <div class="table-wrapper-scroll-y">
        ...
        <div class="table-responsive model_slim_scroll" style="height: 500px">
            ...
            <?php } else if ($type == 'InternationalConferences') { ?>
            ...
            <?php } else if ($type == 'StartupConferences') { ?>
                <table class="table table-striped example_long table-responsive table-bordered table-hover">
                    <thead class="bg-primary-gradient text-white">
                        <tr>
                            <th>Sl no.</th>
            ...
            <?php } else if ($type == 'GovtOfficialTraining') { ?>
                <table class="table table-striped example_long table-bordered table-hover">
                    <thead class="bg-primary-gradient text-white">
                        <tr>
                            <th>Sl no.</th>
            ...
            <?php } else if ($type == 'StudentEnrollment') { ?>
                <table class="table table-striped example_long table-responsive table-bordered table-hover">
                    <thead class="bg-primary-gradient text-white">
                        <tr>
                            <th>Sl no.</th>
            ...
            <?php } else if ($type == 'OpenExperienceCentre') { ?>
                <table class="table table-striped example_long table-bordered table-hover">
                    <thead class="bg-primary-gradient text-white">
                        <tr>
                            <th>Sl no.</th>
                    ...
                    <tbody>
                        <?php foreach ($list as $key => $data) { ?>
                            <tr>
                                <td><?= ++$key ?></td>
                                <td><?= $data['OpenExperienceCentre']['startup_name'] ?></td>
                                <td><?= $data['OpenExperienceCentre']['founder_name'] ?></td>
                                <td><?= $data['OpenExperienceCentre']['email_address'] ?></td>
                                <td><?= $data['OpenExperienceCentre']['mobile_number'] ?></td>
                                <td><?= $data['OpenExperienceCentre']['address'] ?></td>
                                <td><?= date('d-m-Y',strtotime($data['OpenExperienceCentre']['start_date'])) ?></td>
                            </tr>
                        <?php } ?>
                ...
                <table class="table table-striped example_long table-responsive table-bordered table-hover">
                    ...
                    <tbody>
                        <?php foreach ($list as $key => $data) { ?>
                            <tr>
                                <td><?= ++$key ?></td>
                                <td class="text-nowrap"><?= $data['MiMentorship']['mentor_name'] ?></td>
                                <td><?= $data['MiMentorship']['startup_name'] ?></td>
                                <td><?= $data['MiMentorship']['founder_name'] ?></td>
                                <td class="text-nowrap"><?= $data['MiMentorship']['mentor_company'] ?></td>
                                <td><?= $data['MiMentorship']['email'] ?></td>
                                <td><?= $data['MiMentorship']['phone'] ?></td>
                                <td class="text-nowrap"><?= $data['MiMentorship']['address'] ?></td>
                                <td class="text-nowrap"><?= date('d-m-Y',strtotime($data['MiMentorship']['mentorship_start_date'])) ?></td>
                            </tr>
                        <?php } ?>
