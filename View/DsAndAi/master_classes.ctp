  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Master Classes</li>
      </ol>
    </section>
              ...
              <div class="col-lg-4 col-12">
                  <div class="box">
                      <div class="box-body">
                          ...
                          <div class="row">
                              <div class="col-12">
                                  <?php echo $this->Form->create('DsMasterClass',array("class"=>"form-horizontal","type"=>"file",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"DsAndAi","action"=>"masterClasses")));
                                  ...
                                  <div class="form-group">
                                      <label for="example-text-input" class=" col-form-label">Topic<span class="text-danger">*</span></label>
                                          ...
                                          <?php echo $this->Form->input("id",array("type"=>"hidden","label"=>false,'class'=>"form-control","value" => $this->request->data['DsMasterClass']['id']));?>
                                  ...
                                  <div class="box-footer">
                                      <div class="clearfix pull-right">
                                          ...
                                          <?php
                                          if(empty($this->request->data['DsMasterClass']['id'])) {
                              ...
                              <table class="table example_long table-striped table-bordered table-hover" >
                                  ...
                                  if (!empty($table_list)) {
                                      foreach ($table_list as $list) {
                                          ...
                                          <tr>
                                              <td><?php echo $i++;?></td>
                                              <td><?php echo $list['DsMasterClass']['phase'];?></td>
                                              <td><?php echo $list['DsMasterClass']['topic'];?></td>
                                              <td class="text-nowrap"><?php echo $list['DsMasterClass']['date'];?></td>
...
<?php echo $this->Form->create('DsMasterClass',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"DsAndAi","action"=>"masterClasses")));
