        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="p-5 box my-10">
                    <div>
                        <a href="<?php echo $this->webroot .'excel_dounload/ds_ai_professional_trained.xls'; ?>" target="_blank" class="btn btn-sm btn-outline-danger pull-right">Excel Download <i class="fa fa-download"></i> </a>
                        ...
                        <div style="display: none;">
                            <?php
                            echo $this->Form->create('DsAiTrainedProfessional',array("url"=>array("controller"=>"DsAndAi","action"=>"trainedProfessionalImport"),"class"=>"form-horizontal",'id'=>'excel_import_form',"type"=>"file",'onsubmit'=>"return addCsrfToken()"));
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php echo $this->Html->link('List', array("controller" => "DsAndAi", "action" => "professionalsTrainedList"), array("class" => "btn btn-info btn-sm pull-right", "escape" => false,));

                        ?>
                    </div>
                    <?php echo $this->Form->create('DsAiTrainedProfessional', array("class" => "form-horizontal", 'onsubmit' => "return addCsrfToken()", "url" => array("controller" => "DsAndAi", "action" => "professionalsTrained")));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input("collage_name", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Company Name")); ?>
                                        </div>
                                    </div>
                    ...
                    <div class="box-footer">
                        <div class="clearfix pull-right pb-10">
                            ...
                            <?php
                            if(empty($this->request->data['DsAiTrainedProfessional']['id']))
                            {
