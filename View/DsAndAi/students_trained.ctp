...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Students trained</li>
        </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="p-5 box my-10">
                    <div>
                        <a href="<?php echo $this->webroot .'excel_dounload/ds_ai_student_trained.xls'; ?>" target="_blank" class="btn btn-sm btn-outline-danger pull-right">Excel Download <i class="fa fa-download"></i> </a>
                        ...
                        <div style="display: none;">
                            <?php
                            echo $this->Form->create('DsAiTrainedStudent',array("url"=>array("controller"=>"DsAndAi","action"=>"trainedStudentImport"),"class"=>"form-horizontal",'id'=>'excel_import_form',"type"=>"file",'onsubmit'=>"return addCsrfToken()"));
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php echo $this->Html->link('List', array("controller" => "DsAndAi", "action" => "studentsTrainedList"), array("class" => "btn btn-info btn-sm pull-right", "escape" => false,)); ?>
                    </div>
                    <?php echo $this->Form->create('DsAiTrainedStudent', array("class" => "form-horizontal", 'onsubmit' => "return addCsrfToken()", "url" => array("controller" => "DsAndAi", "action" => "studentsTrained")));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input("student_name", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Student Name ")); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 displayNone">
                                        <div class="form-group">
                                           ...
                                           <?php echo $this->Form->input("month",array("type"=>"text","value"=>date('d-m-Y'),"label"=>false,"id"=>"monthPicker","class"=>"form-control",'placeholder'=>'Month Year','required'));?>  </div>
                                    </div>
                                </div>
                            </div>
                            <!-- /.col -->
                    ...
                    <div class="box-footer">
                        <div class="clearfix pull-right pb-10">
                            ...
                            <?php
                            if(empty($this->request->data['DsAiTrainedStudent']['id']))
                            {
...
<script>
    ...
    $('.studentsTrainedList').addClass('active').parents('li').addClass('active')
</script>
