            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('IotInvestorConnect', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Iot", "action" => "mentor")));
                                echo $this->Form->input('csrf_token', array("type" => "hidden", 'id' => 'csrftoken', "label" => false, 'required', "class" => "form-control rounded", 'value' => ' '));
                                echo $this->Form->input('type', array("type" => "hidden", "label" => false, 'required', "value" => "insert")); ?>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-form-label">Name of the Mentor<span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            if ($list['IotInvestorConnect']['type'] == 'Mentoring') {
                                                $id = $list['IotInvestorConnect']['id']; ?>
                                                <tr>
                                                    <td><?php echo $i++; ?></td>

                                                    <td><?php echo $list['IotStartUp']['start_up_name']; ?></td>
                                                    <td><?php echo $list['IotInvestorConnect']['mentor_name']; ?></td>
                                                    <td><?php echo date('d-m-Y',strtotime($list['IotInvestorConnect']['start_date'])); ?></td>
...
<?php echo $this->Form->create('IotInvestorConnect', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Iot", "action" => "mentor")));
...
<script>
    $('.mentoring').addClass('active').parents('li').addClass('active')
</script>