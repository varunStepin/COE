        ...
        <div class="row">
            <div class="col-lg-12">
                    <div class="p-5 box my-10">
                        <div>
                            <a href="<?php echo $this->webroot .'excel_dounload/start_ups_enrolled.xls'; ?>" target="_blank" class="btn btn-sm btn-outline-danger pull-right">Excel Download <i class="fa fa-download"></i> </a>
                            ...
                            <div style="display: none;">
                                <?php
                                echo $this->Form->create('IotStartUp',array("url"=>array("controller"=>"Iot","action"=>"startUpImport"),"class"=>"form-horizontal",'id'=>'excel_import_form',"type"=>"file",'onsubmit'=>"return addCsrfToken()"));
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php echo $this->Html->link('List', array("controller" => "Iot", "action" => "startUpList"), array("class" => "btn btn-info btn-sm pull-right", "escape" => false,));

                        ?>
                    </div>
                    <?php echo $this->Form->create('IotStartUp', array("class" => "form-horizontal", 'onsubmit' => "return addCsrfToken()", "url" => array("controller" => "Iot", "action" => "startUp")));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->input("vertical", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Vertical")); ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="form-group">
