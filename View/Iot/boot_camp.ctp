    ...
    <section class="content-header">
       ...
       Boot Camps
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Boot Camps</li>
        </ol>
    </section>
            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('IotInvestorConnect', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Iot", "action" => "bootCamp")));
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            if ($list['IotInvestorConnect']['type'] == 'Boot Camp') {
...
<?php echo $this->Form->create('IotInvestorConnect', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Iot", "action" => "bootCamp")));
...
<script>
    $('.bootCamp').addClass('active').parents('li').addClass('active')
</script>