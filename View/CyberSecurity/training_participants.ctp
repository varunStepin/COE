      ...
      <section class="content pt-0">
          <div class="row">
              <div class="col-lg-12 col-12">
                  ...
                  <?php echo $this->Form->create('ParticipantsDetail',array("class"=>"form-horizontal","type"=>"file",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"CyberSecurity","action"=>"trainingParticipants")));
                  echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-6 col-md-9">
                                  <div class="pull-right">
                                      ...
                                      <?php echo $this->Html->link('<span> Participants List  </span>',array("controller"=>"CyberSecurity","action"=>"trainingParticipantsList"),array("escape"=>false,"class"=>'btn btn-info btn-sm pull-right'));?>
                                  </div>
                              </div>
                          </div>
                          <div class="row mt-2">
...
<script>
    $('.trainingParticipants').attr('class','active').parents('li').addClass('active')
</script>
