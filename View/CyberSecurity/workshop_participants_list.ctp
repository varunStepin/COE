			...
			<div class="col-lg-12 col-12">
				<div class="box">
					<div class="box-header with-border">
						<?php echo $this->Html->link('<span>Workshop Participants Add  </span>',array("controller"=>"CyberSecurity","action"=>"workshopParticipants"),array("escape"=>false,"class"=>'btn btn-info btn-sm pull-right'));?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						?>
									<tr>
										<td><?php echo $i++;?></td>
										<td><?php echo $list['ManageCyberSecurity']['list_of_workshops_conducted'];?>
										</td>
...
<?php echo $this->Form->create('ParticipantsDetail',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"CyberSecurity","action"=>"workshopParticipantsList")));
