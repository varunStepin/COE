...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#"> Awareness Session Participants</a></li>
		...
		<div class="row">
			<div class="col-lg-12 col-12">
				<div class="p-5 box my-10">
					<div>
						<a href="<?php echo $this->webroot .'excel_dounload/cs_awareness_participants.xls'; ?>"
						...
						<div style="display: none">
							<?php
                              echo $this->Form->create('Participant',array("url"=>array("controller"=>"CyberSecurity","action"=>"importAwarenessSessionParticipant"),"class"=>"form-horizontal",'id'=>'excel_import_form',"type"=>"file",'onsubmit'=>"return addCsrfToken()"));
                              echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));

                              echo $this->Form->input('redirect_to',array("type"=>"hidden","label"=>false,'required',"value"=>"csAwarenessSessionParticipantsList"));
                              echo $this->Form->input('program_type',array("type"=>"hidden","label"=>false,"value"=>"CsAwarenessSession"));
				...
				<?php echo $this->Form->create('ParticipantsDetail',array("class"=>"form-horizontal","type"=>"file",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"CyberSecurity","action"=>"csAwarenessSessionParticipantsList")));
                  echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
						...
						<div class="row">
							...
							<div class="col-sm-6 col-md-9">
								<div class="pull-right">
									...
									<?php echo $this->Html->link('<span> Participants List  </span>',array("controller"=>"CyberSecurity","action"=>"csAwarenessSessionParticipantsList"),array("escape"=>false,"class"=>'btn btn-info btn-sm pull-right'));?>
								</div>
							</div>
						</div>
						<div class="row mt-2">
								...
								<table width="100%" class="table" cellspacing="0" id="dataTable1">
									<tbody>
										<tr class="sub_all">
											...
											<td><?php echo $this->Form->input("ParticipantsDetail.participant_name.",array("type"=>"text","name"=>"participant_name[]","class"=>"form-control","required","label"=>false,"placeholder"=>"Candidate Name"))?>
											</td>
											<td><?php echo $this->Form->input("ParticipantsDetail.organization_name.",array("type"=>"text","name"=>"organization_name[]","class"=>"form-control","required","label"=>false,"placeholder"=>"Organization Name"))?></td>
											<td><?php echo $this->Form->input("ParticipantsDetail.contact_no.",array("type"=>"text","name"=>"contact_no[]","class"=>"form-control isNumber","required",'minlength'=>'10','maxlength'=>'10',"label"=>false,"placeholder"=>"Contact number"))?>
											</td>
