...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Cyber Hygiene Handbook</li>
        </ol>
    </section>
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php 
                                echo $this->Form->create('CyberHygieneHandbook', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "CyberSecurity", "action" => "cyberHygieneHandbook")));
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-form-label">Book Title<span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <?php echo $this->Form->input("book_title", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Book Title")) ?>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-form-label">Release Date<span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $list['CyberHygieneHandbook']['author_name']; ?></td>
...
<?php 
echo $this->Form->create('CyberHygieneHandbook', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "CyberSecurity", "action" => "cyberHygieneHandbook")));
...
<script>
    $('.cyberHygieneHandbook').addClass('active').parents('li').addClass('active')
</script>