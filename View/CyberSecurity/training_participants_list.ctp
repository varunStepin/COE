			...
			<div class="col-lg-12 col-12">
				<div class="box">
					<div class="box-header with-border">
						<?php echo $this->Html->link('<span>Training Participants Add  </span>',array("controller"=>"CyberSecurity","action"=>"trainingParticipants"),array("escape"=>false,"class"=>'btn btn-info btn-sm pull-right'));?>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
                    ...
                    <th>Address</th>
						...
						?>
									<tr>
										...
										<td>
											<a href="#" onclick="addIdToForm(<?php echo $id?>,'delete')"><i style="font-size:12px;"
...
<?php echo $this->Form->create('ParticipantsDetail',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"CyberSecurity","action"=>"trainingParticipantsList")));
