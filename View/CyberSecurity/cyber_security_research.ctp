				...
				<div class="box">
					<div class="box-body">
						...
						<div class="row">
							<div class="col-12">
								<?php 
                                echo $this->Form->create('CyberSecurityResearch', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "CyberSecurity", "action" => "cyberSecurityResearch")));
								...
								<div class="form-group row">
									<label for="example-text-input" class="col-sm-4 col-form-label">Research Title<span
											class="text-danger">*</span></label>
									<div class="col-sm-8">
										<?php echo $this->Form->input("research_title", array("type" => "text", "class" => "form-control", "required", "label" => false, "placeholder" => "Research Title")) ?>
										<?php echo $this->Form->input("id", array("type" => "hidden", "label" => false, 'class' => "form-control", "value" => $this->request->data['CyberSecurityResearch']['id'])); ?>
									</div>
								</div>
								<div class="form-group row">
									<label for="example-text-input" class="col-sm-4 col-form-label">Name Of the
										Candidate<span class="text-danger">*</span></label>
									<div class="col-sm-8">
								...
								<div class="form-group row">
									<label for="example-text-input" class="col-sm-4 col-form-label">Organization
								...
								<div class="box-footer">
									<div class="clearfix pull-right">
										...
										<?php
                                        if (empty($this->request->data['CyberSecurityResearch']['id'])) {
								...
								<tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            $id = $list['CyberSecurityResearch']['id'];
                                    ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['phase']; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['research_title']; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['candidate_name']; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['organization_name']; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['email_id']; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['phone_number']; ?></td>
										<td><?php echo $list['CyberSecurityResearch']['address']; ?></td>
...
<?php echo $this->Form->create('CyberSecurityResearch', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Ktech", "action" => "workshop")));
...
<script>
	$('.cyberSecurityResearch').addClass('active').parents('li').addClass('active')
