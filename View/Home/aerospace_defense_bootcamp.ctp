...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Aerospace Defense Academia-Bootcamp
      </h1>
      <ol class="breadcrumb">
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('AerospaceDefenseBootcamp',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseBootcamp")));
                        echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                        echo $this->Form->input('type',array("type"=>"hidden","label"=>false,'required',"value"=>"insert"));?>
						
						<div class="form-group row">
							<label for="example-text-input" class="col-sm-4 col-form-label">Bootcamp<span class="text-danger">*</span></label>
							<div class="col-sm-8">
								...
								<?php echo $this->Form->input("bootcamp",array("type"=>"text","class"=>"form-control","required","label"=>false,"placeholder"=>"Bootcamp"))?>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $this->Form->input("institute",array("type"=>"select","class"=>"form-control","options"=>array('NMIT'=>'NMIT'),"empty"=>'Select',"required","label"=>false))?>
							</div>
						</div>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['ManageAerospaceDefenseBootcamp']['id']))
                                {
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['AerospaceDefenseBootcamp']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['AerospaceDefenseBootcamp']['bootcamp'];?></td>
							<td><?php echo $list['AerospaceDefenseBootcamp']['duration'];?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseBootcamp']['start_date']));?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseBootcamp']['end_date']));?></td>
							<td><?php echo $list['AerospaceDefenseBootcamp']['phase'];?></td>
                            <td><?php echo $list['AerospaceDefenseBootcamp']['institute'];?></td>
							<td><?php echo $list['AerospaceDefenseBootcamp']['resource_person'];?></td>
							<td><?php echo $list['AerospaceDefenseBootcamp']['details'];?></td>
							<!--<td><?php /*echo $list['AerospaceDefenseBootcamp']['year'];*/?></td>
							<td><?php /*echo $list['AerospaceDefenseBootcamp']['month'];*/?></td>-->
							<td>
...
<?php echo $this->Form->create('AerospaceDefenseBootcamp',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseBootcamp")));
...
<script>
    $('.aerospaceDefenseBootcamp').addClass('active').parents('li').addClass('active');
</script>