...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Aerospace Defense Academia-Value Stream Course
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Value Stream Course</li>
      </ol>
    </section>
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('AerospaceDefenseValueStreamCourse',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseValueStreamCourse")));
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['AerospaceDefenseValueStreamCourse']['id']))
                                {
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['AerospaceDefenseValueStreamCourse']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['AerospaceDefenseValueStreamCourse']['embedded_course'];?></td>
							<td><?php echo $list['AerospaceDefenseValueStreamCourse']['duration'];?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseValueStreamCourse']['start_date']));?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseValueStreamCourse']['end_date']));?></td>
							<td><?php echo $list['AerospaceDefenseValueStreamCourse']['institute'];?></td>
							<td><?php echo $list['AerospaceDefenseValueStreamCourse']['phase'];?></td>
							<td><?php echo $list['AerospaceDefenseValueStreamCourse']['resource_person'];?></td>
							<td><?php echo $list['AerospaceDefenseValueStreamCourse']['details'];?></td>
...
<?php echo $this->Form->create('AerospaceDefenseValueStreamCourse',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseValueStreamCourse")));
...
<script>
    $('.aerospaceDefenseValueStreamCourse').addClass('active').parents('li').addClass('active')
</script>
