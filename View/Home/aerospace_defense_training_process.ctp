...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Aerospace Defense Academia-Training in Process
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Training in Process</li>
      </ol>
    </section>
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('AerospaceDefenseTrainingProcess',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseTrainingProcess")));
                        echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                        echo $this->Form->input('type',array("type"=>"hidden","label"=>false,'required',"value"=>"insert"));?>
						
						<div class="form-group row">
							<label for="example-text-input" class="col-sm-4 col-form-label">Training name<span class="text-danger">*</span></label>
							<div class="col-sm-8">
								...
								<?php echo $this->Form->input("training_name",array("type"=>"text","class"=>"form-control","required","label"=>false,"placeholder"=>"Training name"))?>
							</div>
						</div>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['ManageAerospaceDefenseAcademia']['id']))
                                {
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['AerospaceDefenseTrainingProcess']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['AerospaceDefenseTrainingProcess']['training_name'];?></td>
							<td><?php echo $list['AerospaceDefenseTrainingProcess']['duration'];?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseTrainingProcess']['start_date']));?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseTrainingProcess']['end_date']));?></td>
							<td><?php echo $list['AerospaceDefenseTrainingProcess']['phase'];?></td>
							<td><?php echo $list['AerospaceDefenseTrainingProcess']['institute'];?></td>
							<td><?php echo $list['AerospaceDefenseTrainingProcess']['resource_person'];?></td>
							<td><?php echo $list['AerospaceDefenseTrainingProcess']['details'];?></td>
							<!--<td><?php /*echo $list['AerospaceDefenseTrainingProcess']['year'];*/?></td>
							<td><?php /*echo $list['AerospaceDefenseTrainingProcess']['month'];*/?></td>-->
							<td>
...
<?php echo $this->Form->create('AerospaceDefenseTrainingProcess',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseTrainingProcess")));
...
<script>
    $('.aerospaceDefenseTrainingProcess').addClass('active').parents('li').addClass('active')
</script>