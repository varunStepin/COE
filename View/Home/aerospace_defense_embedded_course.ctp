...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Aerospace Defense Academia-Embedded Course
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Embedded Course</li>
      </ol>
    </section>
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('AerospaceDefenseEmbeddedCourse',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseEmbeddedCourse")));
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['AerospaceDefenseEmbeddedCourse']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['AerospaceDefenseEmbeddedCourse']['embedded_course'];?></td>
							<td><?php echo $list['AerospaceDefenseEmbeddedCourse']['duration'];?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseEmbeddedCourse']['start_date']));?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseEmbeddedCourse']['end_date']));?></td>
							<td><?php echo $list['AerospaceDefenseEmbeddedCourse']['institute'];?></td>
							<td><?php echo $list['AerospaceDefenseEmbeddedCourse']['phase'];?></td>
							<td><?php echo $list['AerospaceDefenseEmbeddedCourse']['resource_person'];?></td>
							<td><?php echo $list['AerospaceDefenseEmbeddedCourse']['details'];?></td>
...
<?php echo $this->Form->create('AerospaceDefenseEmbeddedCourse',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseEmbeddedCourse")));
...
<script>
    $('.aerospaceDefenseEmbeddedCourse').addClass('active').parents('li').addClass('active')
</script>
