...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Aerospace Defense - Value added Course
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-lg-5 col-12">
			  <div class="box">
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('AerospaceDefenseCourse',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseCourse")));
                        echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                        echo $this->Form->input('type',array("type"=>"hidden","label"=>false,'required',"value"=>"insert"));?>
						
						<div class="form-group row">
							<label for="example-text-input" class="col-sm-4 col-form-label">Value added Course Name<span class="text-danger">*</span></label>
							<div class="col-sm-8">
								<?php echo $this->Form->input("id",array("type"=>"hidden","label"=>false,'class'=>"form-control","value" => $this->request->data['AerospaceDefenseCourse']['id']));?>
								<?php echo $this->Form->input("course_name",array("type"=>"text","class"=>"form-control","required","label"=>false,"placeholder"=>"Course Name"))?>
							</div>
						</div>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['AerospaceDefenseCourse']['id']))
                                {
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['AerospaceDefenseCourse']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['AerospaceDefenseCourse']['course_name'];?></td>
							<td><?php echo $list['AerospaceDefenseCourse']['duration'];?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseCourse']['start_date']));?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseCourse']['end_date']));?></td>
							<td><?php echo $list['AerospaceDefenseCourse']['phase'];?></td>
							<td><?php echo $list['AerospaceDefenseCourse']['resource_person'];?></td>
							<td><?php echo $list['AerospaceDefenseCourse']['details'];?></td>
							<!--<td><?php /*echo $list['AerospaceDefenseCourse']['year'];*/?></td>
							<td><?php /*echo $list['AerospaceDefenseCourse']['month'];*/?></td>-->
							<td>
...
<?php echo $this->Form->create('AerospaceDefenseCourse',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseCourse")));
...
<script>
    $('.aerospaceDefenseCourse').addClass('active').parents('li').addClass('active');
</script>
