...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manage Aerospace Defense Training
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Manage Aerospace Defense Training</li>
      </ol>
    </section>
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('ManageAerospaceDefenseTraining',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"manageAerospaceDefenseTraining")));
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
							    <?php echo $this->Form->input("id",array("type"=>"hidden","label"=>false,'class'=>"form-control","value" => $this->request->data['ManageAerospaceDefenseTraining']['id']));?>
								<?php echo $this->Form->input("types",array("type"=>"select","class"=>"form-control","options"=>array('Internship/Foundation Course'=>'Internship/Foundation Course','Advance/Project Based Course'=>'Advance/Project Based Course','Orientation/Awareness Course'=>'Orientation/Awareness Course'),"empty"=>'Select Type',"required","label"=>false))?>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['ManageAerospaceDefenseTraining']['id']))
                                {
						...
						<?php 
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['ManageAerospaceDefenseTraining']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['types'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['internship_program_name'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['duration'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['start_date'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['end_date'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['venue'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['resource_person'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['details'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['year'];?></td>
							<td><?php echo $list['ManageAerospaceDefenseTraining']['month'];?></td>
							<td>
...
<?php echo $this->Form->create('ManageAerospaceDefenseTraining',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"manageAerospaceDefenseTraining")));
