  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Starter Course</li>
      </ol>
    </section>
		 ...
		 <div class="box-body">
		  <div class="row">		  
			<div class="col-lg-6 col-12">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('StarterCourse',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"starterCourse")));
                        echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                        echo $this->Form->input('type',array("type"=>"hidden","label"=>false,'required',"value"=>"insert"));?>

						<div class="form-group row">
							<label for="example-text-input" class="col-sm-4 col-form-label">Starter Course Name<span class="text-danger">*</span></label>
							<div class="col-sm-8">
								<?php echo $this->Form->input("id",array("type"=>"hidden","class"=>"form-control","required","label"=>false))?>
								<?php echo $this->Form->input("starter_program_name",array("type"=>"text","class"=>"form-control","required","label"=>false,"placeholder"=>"Starter Course"))?>
					...
					<div class="col-12">
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['StarterCourse']['id']))
                                {
...
<?php echo $this->Form->create('StarterCourse',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"starterCourse")));
