...
<?= $this->element('cssJs/advance_elements'); ?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Working Professionals Training Program
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Working Professionals Training Program</li>
      </ol>
    </section>
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('ManageWorking',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"manageWorkingTraining")));
                        echo $this->Form->input('csrf_token',array("type"=>"hidden",'id'=>'csrftoken',"label"=>false,'required',"class"=>"form-control rounded",'value'=>' '));
                        echo $this->Form->input('type',array("type"=>"hidden","label"=>false,'required',"value"=>"insert"));?>

						
						<div class="form-group row">
							<label for="example-text-input" class="col-sm-4 col-form-label">No. of Training <span class="text-danger">*</span></label>
							<div class="col-sm-8">
								<?php echo $this->Form->input("no_of_training",array("type"=>"text","class"=>"form-control","required","label"=>false,"placeholder"=>"No. of Programs conducted"))?>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['ManageWorking']['id']))
                                {
						...
						<?php 
							...
							if (!empty($manage_training_list)) {
								...
								foreach ($manage_training_list as $list) {
									$id = $list['ManageWorking']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['ManageWorking']['no_of_training'];?></td>
							<td><?php echo $list['ManageWorking']['program_name'];?></td>
							<td><?php echo $list['ManageWorking']['duration'];?></td>
							<td><?php echo $list['ManageWorking']['date'];?></td>
							<td><?php echo $list['ManageWorking']['venue'];?></td>
							<td><?php echo $list['ManageWorking']['year'];?></td>
							<td><?php echo $list['ManageWorking']['month'];?></td>
							<td>
...
<?php echo $this->Form->create('ManageWorking',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"manageWorkingTraining")));
...
<script>
    ...
    $('.manageWorkingTraining').addClass('active').parents('li').addClass('active');
</script>
