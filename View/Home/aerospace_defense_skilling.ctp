  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Skilling</li>
      </ol>
    </section>
			...
			<!-- Basic Forms -->
			  <div class="box">
				...
				<div class="box-body">
				  ...
				  <div class="row">
					<div class="col-12">
						<?php echo $this->Form->create('AerospaceDefenseSkilling',array("class"=>"form-horizontal",'onsubmit'=>"return addCsrfToken()"),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseSkilling")));
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $this->Form->input("id",array("type"=>"hidden","label"=>false,'class'=>"form-control","value" => $this->request->data['AerospaceDefenseSkilling']['id']));?>
								<?php echo $this->Form->input("skill_name",array("type"=>"text","class"=>"form-control","required","label"=>false,"placeholder"=>"Skill Name"))?>
							</div>
						</div>
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Man Power<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <?php echo $this->Form->input("man_power",array("type"=>"text","placeholder"=>"Man Power","class"=>"form-control","required","label"=>false))?>

                            </div>
                        </div>
						<div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label">Man Hours<span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <?php echo $this->Form->input("man_hour",array("type"=>"text","placeholder"=>"Man Hours","class"=>"form-control","required","label"=>false))?>
                        ...
                        <div class="box-footer">
                            <div class="clearfix pull-right">
                                ...
                                <?php
                                if(empty($this->request->data['AerospaceDefenseSkilling']['id']))
                                {
						...
						<?php
							...
							if (!empty($manage_list)) {
								...
								foreach ($manage_list as $list) {
									$id = $list['AerospaceDefenseSkilling']['id'];
						?>
						<tr>
							<td><?php echo $i++;?></td>
							<td><?php echo $list['AerospaceDefenseSkilling']['skill_name'];?></td>
							<td><?php echo $list['AerospaceDefenseSkilling']['duration'];?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseSkilling']['start_date']));?></td>
							<td><?php echo date('d M Y',strtotime($list['AerospaceDefenseSkilling']['end_date']));?></td>
							<td><?php echo $list['AerospaceDefenseSkilling']['phase'];?></td>
                            <td><?php echo $list['AerospaceDefenseSkilling']['man_power'];?></td>
							<td><?php echo $list['AerospaceDefenseSkilling']['man_hour'];?></td>
							<td><?php echo $list['AerospaceDefenseSkilling']['resource_person'];?></td>
							<td><?php echo $list['AerospaceDefenseSkilling']['details'];?></td>
							<!--<td><?php /*echo $list['AerospaceDefenseSkilling']['year'];*/?></td>
							<td><?php /*echo $list['AerospaceDefenseSkilling']['month'];*/?></td>-->
							<td>
...
<?php echo $this->Form->create('AerospaceDefenseSkilling',array("id"=>"EditDeleteForm","type"=>"file",),array("url"=>array("controller"=>"Home","action"=>"aerospaceDefenseSkilling")));
...
<script>
    $('.aerospaceDefenseSkilling').addClass('active').parents('li').addClass('active');
</script>
