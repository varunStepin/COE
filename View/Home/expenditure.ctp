            ...
            <div class="col-lg-10 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <?php echo $this->Html->link('Expenditure list', array("controller" => "Home", "action" =>$action."List"), array("class" => "ml-5 btn btn-info btn-sm pull-right", "escape" => false,));  ?>
                        ...
                        <div style="display: none">
                                ...
                                <?php
                                echo $this->Form->create('Exel',array("url"=>array("controller"=>"Home","action"=>$action),"class"=>"form-horizontal",'id'=>'excel_import_form',"type"=>"file",'onsubmit'=>"return addCsrfToken()"));
                    ...
                    <div class="box-body">
                        ...
                        <?php echo $this->Form->create('Expenditure', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Home", "action" => $action)));
...
<?php echo $this->Form->create('Expenditure', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Home", "action" => $action)));
