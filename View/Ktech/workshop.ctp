            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('KtechWorkshop', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Ktech", "action" => "workshop")));
                                ...
                                <div class="box-footer">
                                    <div class="clearfix pull-right">
                                        ...
                                        <?php
                                        if (empty($this->request->data['KtechWorkshop']['id'])) {
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            $id = $list['KtechWorkshop']['id'];
                                    ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $list['TbiStartup']['startup_name']; ?></td>
                                                <td><?php echo $list['KtechWorkshop']['candidate_name']; ?></td>
                                                <td><?php echo $list['KtechWorkshop']['organization_name']; ?></td>
                                                <td><?php echo $list['KtechWorkshop']['email_id']; ?></td>
                                                <td><?php echo $list['KtechWorkshop']['phone_number']; ?></td>
                                                <td><?php echo $list['KtechWorkshop']['address']; ?></td>
...
<?php echo $this->Form->create('KtechWorkshop', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Ktech", "action" => "workshop")));
...
<script>
    $('.ktechWorkshops').addClass('active').parents('li').addClass('active')
</script>