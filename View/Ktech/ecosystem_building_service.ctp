...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Ecosystem Building Service</li>
        </ol>
    </section>
            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('KtechEcosystemBuildingService', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Ktech", "action" => "ecosystemBuildingService")));
                                ...
                                <div class="box-footer">
                                    <div class="clearfix pull-right">
                                        ...
                                        <?php
                                        if (empty($this->request->data['KtechEcosystemBuildingService']['id'])) {
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            $id = $list['KtechEcosystemBuildingService']['id'];
                                    ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $list['TbiStartup']['startup_name']; ?></td>
                                                <td><?php echo $list['KtechEcosystemBuildingService']['candidate_name']; ?></td>
                                                <td><?php echo $list['KtechEcosystemBuildingService']['organization_name']; ?></td>
                                                <td><?php echo $list['KtechEcosystemBuildingService']['email_id']; ?></td>
                                                <td><?php echo $list['KtechEcosystemBuildingService']['phone_number']; ?></td>
                                                <td><?php echo $list['KtechEcosystemBuildingService']['address']; ?></td>
...
<?php echo $this->Form->create('KtechEcosystemBuildingService', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Ktech", "action" => "ecosystemBuildingService")));
...
<script>
    $('.ktechEcosystem').addClass('active').parents('li').addClass('active')
</script>