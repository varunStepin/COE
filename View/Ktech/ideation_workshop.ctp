...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Ideation Workshop</li>
        </ol>
    </section>
            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('KtechIdeationWorkshop', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Ktech", "action" => "ideationWorkshop")));
                                ...
                                <div class="box-footer">
                                    <div class="clearfix pull-right">
                                        ...
                                        <?php
                                        if (empty($this->request->data['KtechIdeationWorkshop']['id'])) {
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            $id = $list['KtechIdeationWorkshop']['id'];
                                    ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $list['TbiStartup']['startup_name']; ?></td>
                                                <td><?php echo $list['KtechIdeationWorkshop']['candidate_name']; ?></td>
                                                <td><?php echo $list['KtechIdeationWorkshop']['organization_name']; ?></td>
                                                <td><?php echo $list['KtechIdeationWorkshop']['email_id']; ?></td>
                                                <td><?php echo $list['KtechIdeationWorkshop']['phone_number']; ?></td>
                                                <td><?php echo $list['KtechIdeationWorkshop']['address']; ?></td>
...
<?php echo $this->Form->create('KtechIdeationWorkshop', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Ktech", "action" => "ideationWorkshop")));
...
<script>
    $('.ktechWorkshop').addClass('active').parents('li').addClass('active')
</script>