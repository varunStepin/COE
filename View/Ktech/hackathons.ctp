            ...
            <div class="col-lg-5 col-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <?php echo $this->Form->create('KtechHackthon', array("class" => "form-horizontal", "type" => "file", 'onsubmit' => "return addCsrfToken()"), array("url" => array("controller" => "Ktech", "action" => "hackathons")));
                                ...
                                <div class="box-footer">
                                    <div class="clearfix pull-right">
                                        ...
                                        <?php
                                        if (empty($this->request->data['KtechHackthon']['id'])) {
                                ...
                                <tbody>
                                    ...
                                    if (!empty($table_list)) {
                                        foreach ($table_list as $list) {
                                            $id = $list['KtechHackthon']['id'];
                                    ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $list['TbiStartup']['startup_name']; ?></td>
                                                <td><?php echo $list['KtechHackthon']['candidate_name']; ?></td>
                                                <td><?php echo $list['KtechHackthon']['organization_name']; ?></td>
                                                <td><?php echo $list['KtechHackthon']['email_id']; ?></td>
                                                <td><?php echo $list['KtechHackthon']['phone_number']; ?></td>
                                                <td><?php echo $list['KtechHackthon']['address']; ?></td>
...
<?php echo $this->Form->create('KtechHackthon', array("id" => "EditDeleteForm", "type" => "file",), array("url" => array("controller" => "Ktech", "action" => "hackathons")));
...
<script>
    $('.ktechHackathon').addClass('active').parents('li').addClass('active')
</script>